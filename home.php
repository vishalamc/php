...
<tr>
<td>
<input type="text" placeholder="Mid Term Marks" name="txtmtemarks" required="*"/>
</td>
</tr>
<tr>
<td>
<input type="text" placeholder="End Term Marks" name="txtetemarks" required="*"/>
</td>
</tr>
<tr>
<td>
<input type="text" placeholder="Attendence Marks" name="txtattmarks" required="*"/>
</td>
</tr>
